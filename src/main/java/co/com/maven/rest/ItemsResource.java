...
public class ItemsResource {
    ...
    //Se consume asi localhost:puertoServer/MavenREST/rest/Items
    @GET
    ...
    // //Se consume asi localhost:puertoServer/MavenREST/rest/Items/name=laura
